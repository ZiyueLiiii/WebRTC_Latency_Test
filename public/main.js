...
function addPeer(socket_id, am_initiator) {
    ...
    var repeatInterval = 10; // 2000 ms == 2 seconds
    getStats(peers[socket_id]._pc, function (result) {
        ...
        row.innerHTML = `
            <td>${getTime()}</td>
            <td>${result.bandwidth.videoTPSent*8}</td>
            <td>${result.bandwidth.audioTPSent*8}</td>
            <td>${result.bandwidth.totalTPSent*8}</td>
            <td>${result.video.send.codecs}</td>
            <td>${result.audio.send.codecs}</td>
        ...
        div.innerHTML = `
            ...
            <tbody>
                ...
                <tr>
                    <td>Total Throughput Sent (v+a)</td>
                    <td>${result.bandwidth.totalTPSent}</td>
                </tr>
                <tr>
                    <td>Video Throughput Sent</td>
                    <td>${result.bandwidth.videoTPSent}</td>
                </tr>
                <tr>
                    <td>Audio Throughput Sent</td>
                    <td>${result.bandwidth.audioTPSent}</td>
                </tr>
                <tr>
